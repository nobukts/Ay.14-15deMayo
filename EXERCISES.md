...
1. **Seguridad:** ¿Se validan correctamente los tokens y roles en cada petición protegida?
2. **Arquitectura:** ¿El código del servidor es limpio y utiliza middlewares para tareas transversales (auth, errores)?
3. **Consistencia:** ¿La API responde con códigos de estado HTTP semánticos (200, 201, 400, 401, 403, 500)?

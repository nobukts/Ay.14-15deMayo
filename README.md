...
## 🛠️ Arquitectura del Servidor (Backend)
...
Las contraseñas nunca se almacenan en texto plano. Se utiliza hashing con sal (salt) para asegurar que, incluso en caso de una brecha de seguridad, las credenciales originales sean inaccesibles.
...
## 📝 Ejercicios
Dirígete al archivo `EXERCISES.md` para comenzar con los retos de diseño y seguridad de la API.
